...
export function isCampaignPath(path: string): boolean { return ['/', '/modelos-site', '/criacao-de-sites', '/criacao-de-landing-pages', '/manutencao-de-sites', '/sites-com-painel-administrativo'].includes(path) || path.startsWith('/criacao-de-sites/') || path.startsWith('/exemplos/') }
