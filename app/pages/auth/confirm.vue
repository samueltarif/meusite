...
<template>
  <div class="min-h-screen bg-[#060318] text-white flex items-center justify-center px-4 py-20 relative overflow-hidden">
    ...
    <div class="absolute inset-0 -z-10 pointer-events-none">
      ...
      <div class="absolute left-1/2 -translate-x-1/2 top-0 w-[600px] h-[600px] rounded-full bg-emerald-600/10 blur-[150px]" style="transform: translate3d(0,0,0); backface-visibility: hidden; -webkit-backface-visibility: hidden;" />
    </div>
